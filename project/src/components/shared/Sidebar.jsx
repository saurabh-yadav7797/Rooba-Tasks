...
function Sidebar(){
    return(
        ...
        <div className='flex flex-col content-center bg-white h-435.75 w-86.25'>
        ...
        <div className='flex items-center gap-2 content-center bg-amber-100 w-75.75 h-12.5775 top-50.04 left--1'>
